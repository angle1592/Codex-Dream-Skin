...
- Codex Desktop 26.803.10989 将 Windows 应用菜单顶栏从公开的 `group/application-menu-top-bar` 类迁移到 CSS Module；沉浸背景此前会直接穿透顶栏，导致亮色壁纸上的“文件/编辑/视图/帮助”和窗口按钮难以辨认。现在同时匹配新旧顶栏标记并恢复主题遮罩。
