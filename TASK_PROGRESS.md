...
- [complete] Fetched official `upstream/main@611c101` (`v1.5.6`) and confirmed
  that it contains the Codex 26.721+ home-layout, window-readiness, payload, and
  false-restart fixes matching the installed failure evidence.
- [complete] Created recoverable branch `backup/pre-v1.5.6-20260728` at personal
  downstream commit `62c38a5`.
